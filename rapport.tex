...
\usepackage{hyperref}
\usepackage{listings}
%\usepackage{minted}  % replaced by listings (latexminted broken on Python 3.14)
...
\begin{lstlisting}[basicstyle=\ttfamily\small, backgroundcolor=\color{codebg}, frame=single]
...
\begin{lstlisting}[language=Python, basicstyle=\ttfamily\small, backgroundcolor=\color{codebg}, frame=single]

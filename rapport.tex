...
\begin{boitetech}{Metriques -- execution du 18 mai 2026}
\begin{itemize}[noitemsep]
  \item \textbf{Assets Rapid7 analyses :}
        % [TODO: completer avec les chiffres reels]
  \item \textbf{CIs ServiceNow traites :}
  \item \textbf{Assets decommissionnes encore scannes :}
  \item \textbf{Assets installes absents de Rapid7 :}
  \item \textbf{Assets avec OS EOL ou scan obsolete :}
\end{itemize}
\end{boitetech}
